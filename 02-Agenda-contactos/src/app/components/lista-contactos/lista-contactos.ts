  ...
  template: `
    <mat-card class="section-card">
      <mat-card-content>
        ...
        <mat-tab-group (selectedTabChange)="alCambiarTab($event)">
          <mat-tab label="Todas"></mat-tab>
          <mat-tab label="Personal"></mat-tab>
          <mat-tab label="Trabajo"></mat-tab>
          <mat-tab label="Familia"></mat-tab>
        </mat-tab-group>
                ...
                <div class="contact-main">
                  ...
                  <div class="contact-meta">
                    ...
                    <div class="contact-meta-row">
                      ...
                      <span class="etiqueta-categoria">{{ contacto.categoria | uppercase }}</span>
                    </div>
                  </div>
                </div>
...
export class ListaContactosComponent implements OnInit {
  ...
  alCambiarTab(evento: MatTabChangeEvent): void {
    const categoria = evento.tab.textLabel.toLowerCase();
    this.contactosService.cambiarCategoria(categoria);
  }
}